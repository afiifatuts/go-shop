...
type Order struct {
	...
	//mengcopy data dari OrderCustomer
	...
	DiscountAmount      decimal.Decimal `gorm:"type:decimal(10,2)"`
	...
	ShippingCourier     string          `gorm:"type:100"`
	ShippingCerviceName string          `gorm:"type:100"`
